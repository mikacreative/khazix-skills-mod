...
|---|---|---|
| 🧹 [**neat-freak**](#-neat-freak) | After a session, run `/neat` to reconcile your project docs, CLAUDE.md, agent memory, and project notes with the code | *Coming soon* |
...
After every session, run `/neat`. It reconciles whatever you changed in this conversation against four layers of project knowledge: **docs**, **root CLAUDE.md / AGENTS.md**, the **agent's memory system**, and **project notes**. Outputs a change summary at the end.
...
- Project notes / Obsidian notes (read by the project owner, managers, and cross-tool handoffs)
