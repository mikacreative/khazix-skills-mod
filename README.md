...
| 名字 | 一句话 | 讲解 |
|---|---|---|
| 🧹 [**neat-freak（洁癖）**](#-neat-freak洁癖) | 干完活跑一下 `/neat`，自动把你这次改的东西跟项目文档、CLAUDE.md、Agent 记忆、项目笔记全部对齐 | *待发布* |
...
每次你在 Agent 里干完一件事，跑一下 `/neat`，它会把你这次会话改的东西，跟项目里的**文档**、**CLAUDE.md / AGENTS.md**、**Agent 记忆**、**项目笔记**全部对齐一遍，最后给你一份变更摘要。
...
- Project notes / Obsidian 项目笔记（给项目 owner、管理者和跨工具接手者看的）
